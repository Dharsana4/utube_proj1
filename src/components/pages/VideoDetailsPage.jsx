...
const VideoDetailsPage = () => {
  ...
  useEffect(() => {
    ...
    if (selectedVideo) {
      ...
      setLikes(parseInt(localStorage.getItem(`likes_${id}`)) || selectedVideo.likes);
      setDislikes(parseInt(localStorage.getItem(`dislikes_${id}`)) || selectedVideo.dislikes);
      setIsSubscribed(localStorage.getItem(`subscribed_${id}`) === "true");
      setSubscribers(parseInt(localStorage.getItem(`subscribers_${id}`)) || parseInt(selectedVideo.Subscribers));

      const currentViews = parseInt(localStorage.getItem(`views_${id}`)) || selectedVideo.views;
    ...
    setSuggestedVideos(videosData.filter((v) => v.id !== parseInt(id)).slice(0, 6));
  }, [id]);
  ...
  const handleSubscribe = () => {
    ...
    const newSubscribers = newSubscriptionStatus ? subscribers + 1 : subscribers - 1;
      ...
      <div className="main-video-section">
        ...
        <div className="video-info">
          ...
          <div className="channel-info">
            {video.titleImage && <img src={video.titleImage} alt="Title Icon" className="title-icon" />}
            <h3>{video.channel}</h3>
        ...
        {suggestedVideos.map((suggestion) => (
          ...
          >
            ...
            <div className="suggested-video-info">
              ...
              {suggestion.titleImage && <img src={suggestion.titleImage} alt="Title Icon" className="title-icon" />}
